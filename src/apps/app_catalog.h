...
inline constexpr AppInfo kPet{"Pet", "S:/art/icons/pet.bin"};
inline constexpr AppInfo kPomodoro{"Pomodoro", "S:/art/icons/pomodoro.bin"};
inline constexpr AppInfo kMines{"Minas", "S:/art/icons/minesweeper.bin"};
inline constexpr AppInfo kSettings{"Config", "S:/art/icons/settings.bin"};
}  // namespace catalog
